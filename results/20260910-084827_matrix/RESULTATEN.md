...
- Hoogste piek over alle runs: **11.6 GB** (100%), in `sweep_s30_c64k`. Dat is het getal waartegen een kleinere kaart hieronder wordt afgemeten.
...
Dat getal geldt voor de sweep-runs met 20 studenten. Over *alle* runs samen ligt de piek hoger: 11.6 GB (100%) in `sweep_s30_c64k` — 30 studenten, 64k context. Vraag 3 rekent met die hogere piek.
...
Er zijn twee getallen in omloop, en ze geven een ander antwoord. Een klas van 20 in de sweep kwam niet hoger dan **11.5 GB**. De zwaarste run uit de hele meting — `sweep_s30_c64k`, 30 studenten, 64k context — vroeg **11.6 GB**. De kolom **Past?** hieronder oordeelt op dat tweede getal: een kaart die de zwaarste gemeten belasting niet aankan, kun je niet aanbevelen omdat het gemiddelde er wel op past.
